...
export const computeServices = [
  {
    ...
    relatedServices: ['ebs', 'elb', 'autoscaling', 'vpc', 'iam']
  },
  {
    id: 'batch',
    name: 'AWS Batch',
    ...
    relatedServices: ['ec2', 'fargate', 'iam', 's3']
  },
  {
    id: 'beanstalk',
    ...
    relatedServices: ['ec2', 'elb', 'rds', 's3']
  },
  {
    id: 'lambda',
    name: 'AWS Lambda',
    ...
    relatedServices: ['apigateway', 's3', 'dynamodb', 'eventbridge', 'iam']
  },
  {
    id: 'sar',
    ...
    relatedServices: ['lambda', 'cloudformation', 'iam']
  },
  {
    id: 'fargate',
    name: 'AWS Fargate',
    ...
    relatedServices: ['ecs', 'eks', 'ecr', 'elb', 'iam']
  }
];
