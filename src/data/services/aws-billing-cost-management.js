...
export const billingCostManagementServices = [
  {
    ...
    relatedServices: ['budgets', 'cur', 'organizations', 'cloudtrail']
  },
  {
    id: 'budgets',
    name: 'AWS Budgets',
    ...
    relatedServices: ['costexplorer', 'sns', 'iam', 'organizations']
  },
  {
    id: 'cur',
    ...
    relatedServices: ['s3', 'athena', 'quicksight', 'costexplorer']
  },
  {
    id: 'ri-reporting',
    ...
    relatedServices: ['costexplorer', 'budgets', 'organizations']
  },
  {
    id: 'reporting',
    ...
    relatedServices: ['costexplorer', 'budgets', 'cur', 'organizations']
  }
];
