...
export const developerToolsServices = [
  {
    ...
    relatedServices: ['codecommit', 'codepipeline', 'codedeploy', 's3']
  },
  {
    id: 'codecommit',
    name: 'AWS CodeCommit',
    ...
    relatedServices: ['codebuild', 'codepipeline', 'codedeploy', 'sns']
  },
  {
    id: 'codedeploy',
    name: 'AWS CodeDeploy',
    ...
    relatedServices: ['codepipeline', 'codecommit', 'ec2', 'lambda', 'cloudwatch']
  },
  {
    id: 'xray',
    name: 'AWS X-Ray',
    ...
    relatedServices: ['lambda', 'ecs', 'ec2', 'cloudwatch', 'apigateway']
  }
];
