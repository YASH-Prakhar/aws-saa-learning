...
export const securityServices = [
  {
    ...
    relatedServices: ['kms', 'secretsmanager', 'organizations', 'cloudtrail']
  },
  {
    id: 'cognito',
    name: 'Amazon Cognito',
    ...
    relatedServices: ['iam', 'appsync', 'lambda', 'apigateway']
  },
  {
    id: 'directoryservice',
  ...
  },
  {
    ...
    relatedServices: ['iam', 'organizations', 'vpc']
  },
  {
    id: 'secretsmanager',
    ...
    relatedServices: ['kms', 'iam', 'rds', 'lambda']
  },
  {
    id: 'securityhub',
    ...
    relatedServices: ['cloudtrail', 'config', 'guardduty', 'cloudwatch', 'eventbridge']
  }
];
